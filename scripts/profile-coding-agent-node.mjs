...
const agentDirEnvName = "CODEIFY_CODING_AGENT_DIR";
const startupBenchmarkEnvName = "CODEIFY_STARTUP_BENCHMARK";
...
Options:
  ...
  --agent-dir <dir>      Use a specific CODEIFY_CODING_AGENT_DIR for the benchmark run
  --isolated-agent-dir   Use a fresh temporary agent dir instead of the normal one
  --no-offline           Do not force CODEIFY_OFFLINE=1
