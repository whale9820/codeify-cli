 ...
 *
 * Existing apps switch imports from "codeify-ai" to
 * "codeify-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "codeify-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "codeify-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "codeify-ai/providers/all" or `Models.getProviders()`. */
 ...
 * clobbering existing entries: compat may load after a test or runtime provider has
