...
export type { RuntimeProviderConfig } from "./provider-composer.ts";
...
/**
 * Synchronous facade over ModelRuntime.
 */
export class ModelRegistry {
	...
	registerProvider(providerName: string, config: RuntimeProviderConfig): void;
	registerProvider(providerOrName: Provider | string, config?: RuntimeProviderConfig): void {
	...
	getRegisteredProviderConfig(providerName: string): RuntimeProviderConfig | undefined {
