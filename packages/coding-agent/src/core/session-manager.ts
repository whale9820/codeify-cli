...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "codeify-ai";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	usage?: Usage;
	/** True if generated by an alternate compaction provider. */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	fromId: string;
	summary: string;
	/** Additional data not sent to the model. */
	details?: T;
...
/**
 * Custom entry for application state in the session.
 * Use customType to identify the entry category.
 *
 * Purpose: Persist application state across session reloads.
 *
...
/**
 * Custom message entry that participates in model context.
 * Use customType to identify the entry category.
 *
 * Unlike CustomEntry, this DOES participate in LLM context.
 * The content is converted to a user message in buildSessionContext().
 * Use details for metadata that is not sent to the model.
 *
...
export class SessionManager {
	...
	/**
	 * Append a custom message entry that participates in model context.
	 * @param customType Entry category used when rendering or reloading
	 * @param content Message content (string or TextContent/ImageContent array)
	 * @param display Whether to show in TUI (true = styled display, false = hidden)
	 * @param details Optional metadata (not sent to the model)
	 * @returns Entry id
	 */
