...
import type { Transport } from "codeify-ai";
...
export class SettingsManager {
	...
	getSmartModelUsage(): boolean {
		return this.settings.smartModelUsage ?? false;
	}

	setSmartModelUsage(enabled: boolean): void {
		this.globalSettings.smartModelUsage = enabled;
		this.markModified("smartModelUsage");
		this.save();
	}
	...
	getClearOnShrink(): boolean {
		...
		return process.env.CODEIFY_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.CODEIFY_HARDWARE_CURSOR === "1";
	}
