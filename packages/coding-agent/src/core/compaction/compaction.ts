...
import type { AgentMessage, StreamFn, ThinkingLevel } from "codeify-agent-core";
import { contentText, type RetryCallbacks, type RetryPolicy, retryAssistantCall } from "codeify-ai";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "codeify-ai/compat";
import { completeSimple } from "codeify-ai/compat";
...
export interface CompactionResult<T = unknown> {
	...
	usage?: Usage;
	/** Additional data for structured compaction. */
	details?: T;
}
