    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="codeify-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="codeify-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'codeify-share:v1:sidebar-width';
