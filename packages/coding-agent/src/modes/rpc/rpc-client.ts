...
export class RpcClient {
	 ...
	 * @returns Whether the switch was cancelled.
	 */
	 ...
	 * @returns The selected text and cancellation state.
	 */
	 ...
	 * @returns Whether the clone was cancelled.
	 */
	...
	/**
	 * Get available prompt templates and skills.
	 */
