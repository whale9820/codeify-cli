...
Codeify CLI runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
# Install codeify
npm install -g --ignore-scripts codeify-cli

# Create config directory
mkdir -p ~/.codeify/agent
...
Create `~/.codeify/agent/AGENTS.md` to help the agent understand the Termux environment:
