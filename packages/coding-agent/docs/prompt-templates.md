> Codeify can create prompt templates. Ask it to build one for your workflow.
...
Codeify loads prompt templates from:

- Global: `~/.codeify/agent/prompts/*.md`
- Project: `.codeify/prompts/*.md` (only after the project is trusted)
...
- If you want templates in subdirectories, add them explicitly through the `prompts` setting.
