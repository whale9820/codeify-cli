...
import type { AssistantMessage, Model } from "codeify-ai";
...
vi.mock("codeify-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("codeify-ai/compat")>();
	return {
		...actual,
